...
class BedrockClinicalAssistant:
    """Path B — fast Bedrock Converse model for live clinician assistance."""
            ...
            parsed.append(
                {
                    ...
                    "title": str(item.get("title", "Documentation note")).strip() or "Documentation note",
                    "body": body,
