...
class UnavailableTranscriptionProvider:
    ...
    def transcribe(self, audio: bytes, content_type: str | None = None) -> TranscriptionResult:
        raise TranscriptionUnavailable(
            ...
            "Use browser speech-to-text, or set MEDEXA_TRANSCRIPTION_PROVIDER=aws_transcribe."
        )
...
class AwsTranscribeProvider:
    ...
    def _poll_job(self, client, job_name: str) -> TranscriptionResult:
    ...
    def _parse_transcript_output(self, job: dict) -> TranscriptionResult:
